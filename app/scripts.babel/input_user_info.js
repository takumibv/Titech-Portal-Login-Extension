...
if(!usr_pswd){
	$("center").eq(1).append(
		"<div id='option_link'>"
		+	"<p>"+ chrome.i18n.getMessage("con_setting_account_msg") + "</p>"
		+	"<p class='note'>"+ chrome.i18n.getMessage("con_chrome_extension") + "</p>"
		+"</div>"
	);
}else if(!is_valid){
	$("center").eq(1).append(
		"<div id='option_link'>"
		+	"<p>"+ chrome.i18n.getMessage("con_invalid_msg") + "</p>"
		+	"<p class='note'>"+ chrome.i18n.getMessage("con_chrome_extension") + "</p>"
		+"</div>"
	);
}else{
